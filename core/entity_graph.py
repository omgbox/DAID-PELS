...
class EntityGraph(BaseModule):
    ...
    def process(self, input_data) -> dict:
        ...
        edges.extend(self._build_svo_edges(svo_triples))
    ...
    def _build_cooccurrence_edges(self, sentences: List[Dict],
        ...
        """
        Build co-occurrence edges between entities.
    ...
    def _build_svo_edges(self, svo_triples: List[Dict]) -> List[Dict]:
        """
        Build edges from SVO triples.

        Args:
            svo_triples: List of SVO triple dicts
